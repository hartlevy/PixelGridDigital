...
const int LRG_DIGIT_IMAGE_RESOURCE_IDS[10] = {
  RESOURCE_ID_LARGEDIGIT0,
  RESOURCE_ID_LARGEDIGIT1,
  RESOURCE_ID_LARGEDIGIT2,
  RESOURCE_ID_LARGEDIGIT3,
  RESOURCE_ID_LARGEDIGIT4,
  RESOURCE_ID_LARGEDIGIT5,  
  RESOURCE_ID_LARGEDIGIT6,
  RESOURCE_ID_LARGEDIGIT7,
  RESOURCE_ID_LARGEDIGIT8,
  RESOURCE_ID_LARGEDIGIT9
};

const int MED_DIGIT_IMAGE_RESOURCE_IDS[10] = {
...
const int SM_DIGIT_IMAGE_RESOURCE_IDS[10] = {
